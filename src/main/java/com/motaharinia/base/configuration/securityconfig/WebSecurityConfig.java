 ...
 * برای فعال کردن امنیت HTTP در Spring ، باید WebSecurityConfigurerAdapter را گسترش دهیم تا پیکربندی پیش فرض را در متد پیکربندی (HttpSecurity http) ارائه دهیم:
 ...
 * بیایید با کاربرانی شروع کنیم که به صفحه ما لاگین نشده اند.
